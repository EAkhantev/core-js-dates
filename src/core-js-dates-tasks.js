...
function getWeekNumberByDate(date) {
  ...
  const numberDaysFirstWeek = 7 - firstDayYear.getUTCDay();
  const diffDays = (date - firstDayYear) / (1000 * 60 * 60 * 24);
  const numberWeeks = Math.ceil((diffDays + 1 - numberDaysFirstWeek) / 7);
